...
import { } from "../roleModule/PlayerData"
 import {SGetIncomes,SIncomeRecordInfo,SIncomeRecords,SIncomesInfo} from "../roleModule/PlayerStruct";
import { AutoScroller } from "../../utils/AutoScroller";
import { EventMgr, Evt_GetIncomeRecords } from "../../manager/EventMgr";
...
export class FriendIncomeListPanel extends Panel {
    protected prefab: string = "prefabs/panel/friend/FriendIncomeListPanel";
    ...
    private async updateItem(item: Node, data: SIncomeRecordInfo, index: number) {
        ...
        let icon1 = item.getChildByPath("frame/incomeNode/lbl/彩钻").getComponent(Sprite);
        ...
        icon1.spriteFrame = await ResMgr.LoadResAbSub("sheets/common/lingshi/spriteFrame", SpriteFrame);
