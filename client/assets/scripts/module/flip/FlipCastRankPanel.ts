...
import { EventMgr, Evt_FlipRankUpdate } from "../../manager/EventMgr";
import { SFlipRankPlayerInfoData } from "../roleModule/PlayerStruct";
import { Session } from "../../net/Session";
import { MsgTypeSend } from "../../MsgType";

export class FlipCastRankPanel extends Panel {
    protected prefab: string = "prefabs/panel/flip/FlipCastRankPanel";
    ...
    protected onShow(): void {
        ...
        EventMgr.on(Evt_FlipRankUpdate, this.onRankUpdate, this);
        Session.Send({type: MsgTypeSend.FlipRankQuery, data:{}});
    }

    protected onHide(...args: any[]): void {
        EventMgr.off(Evt_FlipRankUpdate, this.onRankUpdate, this);
    }

    private onRankUpdate(rankList: SFlipRankPlayerInfoData[]): void {
        if (rankList.length) {
    ...
    protected updateItem(item: Node, data: SFlipRankPlayerInfoData, index: number): void {
