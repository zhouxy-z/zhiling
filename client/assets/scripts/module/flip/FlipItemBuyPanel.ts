...
export class FlipItemBuyPanel extends Panel {
    protected prefab: string = "prefabs/panel/flip/FlipItemBuyPanel";
    ...
    protected onLoad(): void {
        ...
        this.step = CfgMgr.GetFlipConvertNum(CfgMgr.GetFlipCommon.CostItemID);
        this.rote = CfgMgr.GetFlipCommon.ConvertPrice / this.step;
