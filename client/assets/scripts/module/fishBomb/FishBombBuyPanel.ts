...
export class FishBombBuyPanel extends Panel {
    protected prefab: string = "prefabs/panel/fishBomb/FishBombBuyPanel";
    ...
    protected onLoad(): void {
        ...
        this.step = CfgMgr.GetFishBombConvertNum(CfgMgr.GetFishBombComm.CostItemID);
        this.rote = CfgMgr.GetFishBombComm.ConvertPrice / this.step;
    }
    ...
    protected onShow(): void {
        EventMgr.on(Evt_Currency_Updtae, this.onCurrencyChange, this);
    }

    protected onHide(...args: any[]): void {
        EventMgr.off(Evt_Currency_Updtae, this.onCurrencyChange, this);
    }
    ...
    private onBtnClick(btn:Button):void{
        switch (btn) {
            ...
            case this.btn:
                ...
                Session.Send({type: MsgTypeSend.FishingBombConvertItem, data:{count:this.curNum * this.rote}});
                break;
        }
