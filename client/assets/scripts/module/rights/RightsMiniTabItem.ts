...
import { StdEquityCard } from "../../manager/CfgMgr";
import PlayerData from "../roleModule/PlayerData";
import { EventMgr, Evt_RightsGetReward } from "../../manager/EventMgr";

export class RightsMiniTabItem extends Component {
    private def:Node;
    ...
    private updateShow():void {
        ...
        this.defLab.string = this.std.TabName;
        this.selectLab.string = this.std.TabName;
        this.updateRedPoint();
    }
    private updateRedPoint():void{
        if(!this.std) return;
        this.redPoint.active = PlayerData.CheckEquityMiniTabRead(this.std.Equity_CardID);
    }
}