...
import { Evt_Currency_Updtae } from "../../manager/EventMgr";

export class FishTradeItemBuyPanel extends Panel {
    protected prefab: string = "prefabs/panel/fishTrade/FishTradeItemBuyPanel";
    ...
    protected onLoad(): void {
        ...
        this.step = CfgMgr.GetFishTradeConvertNum(CfgMgr.GetFishTradeCommon.CostItemID);
        this.rote = CfgMgr.GetFishTradeCommon.ConvertPrice / this.step;
    ...
    private onBtnClick(btn:Button):void{
        switch (btn) {
            ...
            case this.btn:
                ...
                Session.Send({type: MsgTypeSend.FishingTradeConvertItem, data:{count:this.curNum * this.rote}});
                break;
        }
