...
/**先锋服获取公告列表 */
export const SendGetAllNoticeXf: HttpInterface = {
    serverUrl: "https://mgapi.chaoyouhuyu.com",
    uri: "/biz-marketing/public/announcement/getAll",
    headers: { "X-SERVER-APP-ID": "zljqxf", "X-APP-ID": "zljqxf" },
    isGet: false,
};
// /**精英服获取排行榜数据列表 */
// export const SendGetRankDataJy: HttpInterface = {
//     serverUrl: "https://zlrankdata-jy.chaoyouhuyu.com",
//     uri: "/ranking",
// };

// /**畅游服获取排行榜数据列表 */
// export const SendGetRankData: HttpInterface = {
//     serverUrl: "https://zlrankdata.chaoyouhuyu.com",
//     uri: "/ranking",
// };

/**畅游服获取排行榜数据列表 */
export const SendGetRankData: HttpInterface = {
    serverUrl: GameSet.Server_cfg.Rank,
    uri: "/ranking",
};
...
/**获取排行榜数据列表 */
export const SendGetCurrencyRankData: HttpInterface = {
    serverUrl: "http://192.168.0.93:9898",
    uri: "/currency/ranking",
};
...
export class Http {
    ...
    private static async request(serverUrl: string, uri: string, header: Record<string, string>, method: string, body: any): Promise<Response> {
        let url = `${serverUrl || GameSet.Local_host || SERVER_HOST}${uri}`;
        let json = "";
